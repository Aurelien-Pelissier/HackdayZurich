...
questions += ['3_2_1_1'] #Is_solar
questions += ['3_2_1_3'] #Solar power (kW)
...
#question_label += []
question_label += ['Is solar ?']
question_label += ['Solar power (kW)']
...
for label in df.columns:
    ...
    if QQ in questions:
        ...
        data = np.array([str(x).replace(',','.') for x in data if x!=' '])
        try:
